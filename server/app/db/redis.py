...
class Redis:
    ...
    async def sadd(self, key: str, *values: Any) -> int:
        try:
            ...
            return await self._client.sadd(key, *processed_values)
        except Exception as e:
    ...
    async def srem(self, key: str, *values: Any) -> int:
        try:
            ...
            return await self._client.srem(key, *processed_values)
        except Exception as e:
            logger.error(f"Failed removing from set {key}: {e}")
            return 0
    
    async def smembers(self, key: str, decode_json: bool = False) -> set:
        try:
